...
Ce workspace est le Jarvis personnel de Bilal. Il a été créé avec le Jarvis Starter Kit pour servir d'assistant IA personnel au quotidien.
...
Je m'appelle Bilal et je vis à Dubaï. Je suis un entrepreneur discipliné et déterminé à réussir en grand. Je dirige Les Rois du Web, une agence de marketing digital avec près de 900 clients, à qui je propose du référencement naturel, du Google Ads, du Facebook Ads et de la création de sites. Je cible des artisans (couvreurs, élagueurs, débarras) par département et par métier, peu importe le pays, et mon acquisition passe surtout par TikTok (un post par jour d'un client satisfait) et Snap (stories de résultats).

Mes objectifs prioritaires actuels : atteindre 500 000 euros par mois de chiffre d'affaires, finir la première version de mon application de devis vocaux et lancer mes Facebook Ads.

À long terme, je veux faire des Rois du Web une référence mondiale, lancer plusieurs applications rentables, développer des marques de e-commerce et placer des investissements intéressants.

Le domaine où j'ai besoin du plus d'aide en ce moment : le copywriting et l'optimisation de mes Facebook Ads, la création de mon application de devis, et mon business en général.
